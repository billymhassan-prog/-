...
export default function ManagerHub() {
  ...
  const askAI = useCallback(async (question?: string) => {
    ...
    const repData = {
      attainment: repAttainment, pipeline: repPipeline, activity: repL12DActivity,
      ndg: repNDG, cwnft: repCWnFT, coaching: repCoaching, teamNDG, teamCWnFT,
      weeklyPacing, forecast: getTeamForecast(),
    ...
    try {
      const resp = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/coaching-insights`, {
        ...
        body: JSON.stringify({ repData, teamContext: { mode: 'manager_advisor', question: prompt } }),
      });
      if (!resp.ok) {
  ...
  }, [aiInput, teamMembers, visibleAlerts, oneOnOnes]);
