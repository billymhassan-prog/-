  ...
  const generateAiSummary = useCallback(async () => {
    ...
    try {
      const repData = {
        ...
        weeklyPacing, weeklyFTPoints: repWeeklyFTPoints, teamInsights,
        hiringNotes: hiringNotes.trim() || 'No updates.',
      };
      const resp = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/coaching-insights`, {
        ...
        body: JSON.stringify({ repData, teamContext: { mode: 'summary_report', summaryType } }),
      });
      if (!resp.ok) {
